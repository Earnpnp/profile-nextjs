      ...
      <Element name="about">
        <main className="w-full flex items-center justify-center">
          ...
          <section
            ...
            id="about"
          >
            {/* <div className="w-full max-w-sm md:max-w-5xl flex items-center justify-center my-4 flex-wrap gap-10"></div> */}
            ...
            <div className="w-full h-420 flex flex-col justify-center gap-4">
              <h1 className="text-4xl md:text-7xl text-slate-400 font-bold mb-5">
                Hi there 👋
              </h1>
              <p className="text-2xl md:text-4xl text-slate-500">
                Pannaporn Chamnanaksorn
              </p>
              <p className="fullstackdev">Full Stack Developer</p>
              <button
                className="font-medium mt-20 text-black hover:text-slate-400 bg-slate-300
                cursor-pointer  px-2 py-1 rounded-lg 
               border border-zinc-800  shadow-[7px_7px_0px_2px_black] p-2 md:max-w-[500px] 
